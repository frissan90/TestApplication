    ...
    <div class="row-content">
        ...
        <div class="row-content large-6">
            ...
            <div class=" large-6 medium-6 small-12">
                <asp:Label ID="LabelA10" CssClass="label PTLabels" runat="server" Text="Användarnamn"></asp:Label><asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="UnameATB" ValidationGroup="registerEditor" ErrorMessage="1) Användarnamn krävs" ForeColor="Red">1</asp:RequiredFieldValidator>
            ...
            <div class=" large-6 medium-6 small-12">
                <asp:Label ID="LabelA1" CssClass="label PTLabels" runat="server" Text="Epost"></asp:Label>
            ...
            <div class=" large-6 medium-6 small-12">
                <asp:Label ID="LabelA2" CssClass="label PTLabels" runat="server" Text="Lösenord"></asp:Label><asp:RequiredFieldValidator ID="fv2A" runat="server" ControlToValidate="PWTBA" ValidationGroup="registerEditor" ErrorMessage="3) Lösenord krävs" ForeColor="Red">3</asp:RequiredFieldValidator>
                <asp:TextBox ID="PWTBA" runat="server" placeholder="Lösenord" TextMode="Password"></asp:TextBox>
            </div>
            <div class=" large-6 medium-6 small-12">
                <asp:Label ID="LabelA3" CssClass="label PTLabels" runat="server" Text="Upprepa lösenord"></asp:Label><asp:RequiredFieldValidator ID="fv3A" runat="server" ControlToValidate="ConfPWTBA" ValidationGroup="registerEditor" ErrorMessage="4) Vänligen upprepa lösenordet" ForeColor="Red">4</asp:RequiredFieldValidator>
            ...
            <div class=" large-6 medium-6 small-12">
                <asp:Label ID="LabelA4" CssClass="label PTLabels" runat="server" Text="Förnamn"></asp:Label><asp:RequiredFieldValidator ID="fv4A" runat="server" ControlToValidate="FnameATB" ValidationGroup="registerEditor" ErrorMessage="5) Förnamn krävs" ForeColor="Red">5</asp:RequiredFieldValidator>
                <asp:TextBox ID="FnameATB" placeholder="Förnamn" runat="server"></asp:TextBox>
            </div>
            <div class=" large-6 medium-6 small-12">
                <asp:Label ID="LabelA5" CssClass="label PTLabels" runat="server" Text="Efternamn"></asp:Label><asp:RequiredFieldValidator ID="fv5A" runat="server" ControlToValidate="LnameATB" ValidationGroup="registerEditor" ErrorMessage="6) Efternamn krävs" ForeColor="Red">6</asp:RequiredFieldValidator>
