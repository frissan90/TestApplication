    ...
    <div class="panelW">
        ...
        <div class="row">
            ...
            <div class="large-3 medium-6 large-offset-4 columns ">
                ...
                <asp:Label runat="server" ID="Label3" CssClass="PTLabels2">Giltighetsdatum på kortet: <br /><br />Månad</asp:Label>
            ...
            <asp:TextBox ID="cvctb" runat="server" placeholder="555" CssClass="textbox3"></asp:TextBox><asp:Label runat="server" ForeColor="Red" ID="cvcFail"></asp:Label>
