<%@ Page Title="" Language="C#" MasterPageFile="~/PhoneToysFinal.Master" AutoEventWireup="true" CodeBehind="RedigeraSagor1.aspx.cs" Inherits="PhoneToys.RedigeraSagor1" %>
    ...
    <asp:ListView runat="server" ID="SagorEditLoad" GroupItemCount="1" OnItemCommand="SagorEditLoad_ItemCommand">
        ...
        <ItemTemplate>
            <div class="large-8 medium-6 small-12 columns">
              <Img ID="Image1" runat="server" CssClass="large-4 medium-4 small-6" src='<%#Eval("bilden") %>' />
