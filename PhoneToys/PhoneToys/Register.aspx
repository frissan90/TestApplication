...
<%--    <ajaxToolkit:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server"></ajaxToolkit:ToolkitScriptManager>--%>
    ...
    <div class="columns large-4 medium-4 small-4" style="float:left";>
        <asp:Label runat="server" Text="Epost" ForeColor="Navy"></asp:Label>
        <asp:TextBox CssClass="large-3 medium-3 small-3"  ID="EmailTB" runat="server" Style="width:300px;"></asp:TextBox>
        <asp:RequiredFieldValidator ID="fv1" runat="server" ControlToValidate="EmailTB" ValidationGroup="register" ErrorMessage="Epost krävs" ForeColor="Red">*</asp:RequiredFieldValidator>
<%--       <ajaxToolkit:TextBoxWatermarkExtender ID="w1" runat="server" WatermarkText="E-mail adress" TargetControlID="EmailTB"></ajaxToolkit:TextBoxWatermarkExtender>--%>
        <br />
        <asp:Label ID="Label1" runat="server" Text="Lösenord" ForeColor="Navy"></asp:Label>
        <asp:TextBox CssClass="large-3 medium-3 small-3" ID="PWTB" runat="server" Style="width:300px;" TextMode="Password"></asp:TextBox>
        <asp:RequiredFieldValidator ID="fv2" runat="server" ControlToValidate="PWTB" ValidationGroup="register" ErrorMessage="Lösenord krävs" ForeColor="Red">*</asp:RequiredFieldValidator>
        <asp:Label ID="Label2"  runat="server" Text="Upprepa lösenord" ForeColor="Navy"></asp:Label>
        <asp:TextBox CssClass="large-3 medium-3 small-3" ID="ConfPWTB" runat="server" Style="width:300px;" TextMode="Password"></asp:TextBox>
        <asp:RequiredFieldValidator ID="fv3" runat="server" ControlToValidate="ConfPWTB" ValidationGroup="register" ErrorMessage="Vänligen upprepa lösenordet" ForeColor="Red">*</asp:RequiredFieldValidator>
        <asp:Label ID="Label3" runat="server" Text="Förnamn" ForeColor="Navy"></asp:Label>
        <asp:TextBox CssClass="large-3 medium-3 small-3" ID="FnameTB" runat="server" Style="width:300px;"></asp:TextBox>
        <asp:RequiredFieldValidator ID="fv4" runat="server" ControlToValidate="FnameTB" ValidationGroup="register" ErrorMessage="Förnamn krävs" ForeColor="Red">*</asp:RequiredFieldValidator>
<%--        <ajaxToolkit:TextBoxWatermarkExtender ID="w2" runat="server" WatermarkText="Förnamn" TargetControlID="FNameTB"></ajaxToolkit:TextBoxWatermarkExtender>--%>
        <asp:Label ID="Label4" runat="server" Text="Efternamn" ForeColor="Navy"></asp:Label>
        <asp:TextBox CssClass="large-3 medium-3 small-3" ID="LnameTB" runat="server" Style="width:300px;"></asp:TextBox>
        <asp:RequiredFieldValidator ID="fv5" runat="server" ControlToValidate="LnameTB" ValidationGroup="register" ErrorMessage="Efternamn krävs" ForeColor="Red">*</asp:RequiredFieldValidator>
<%--        <ajaxToolkit:TextBoxWatermarkExtender ID="w3" runat="server" WatermarkText="Efternamn" TargetControlID="LNameTB"></ajaxToolkit:TextBoxWatermarkExtender>--%>
    ...
    <div class="columns large-4 medium-4 small-4" style="float:left; margin-left:50px;">
        <asp:Label ID="Label5" runat="server" Text="Adress" ForeColor="Navy"></asp:Label>
        <asp:TextBox CssClass="large-3 medium-3 small-3" ID="AddressTB" runat="server" Style="width:300px;"></asp:TextBox>
        <asp:RequiredFieldValidator runat="server" ControlToValidate="AddressTB" ValidationGroup="register" ErrorMessage="Adress krävs" ForeColor="Red">*</asp:RequiredFieldValidator>
<%--        <ajaxToolkit:TextBoxWatermarkExtender ID="w4" runat="server" WatermarkText="Adress" TargetControlID="AddressTB"></ajaxToolkit:TextBoxWatermarkExtender>--%>
        <asp:Label ID="Label6" runat="server" Text="Postnummer" ForeColor="Navy"></asp:Label>
        <asp:TextBox CssClass="large-3 medium-3 small-3" ID="ZipTB" runat="server" Style="width:300px;"></asp:TextBox>
        <asp:RequiredFieldValidator runat="server" ControlToValidate="ZipTB" ValidationGroup="register" ErrorMessage="Posrnummer krävs" ForeColor="Red">*</asp:RequiredFieldValidator>
<%--        <ajaxToolkit:TextBoxWatermarkExtender ID="w5" runat="server" WatermarkText="Postnummer" TargetControlID="ZipTB"></ajaxToolkit:TextBoxWatermarkExtender>--%>
        <asp:Label ID="Label7" runat="server" Text="Stad" ForeColor="Navy"></asp:Label>
        <asp:TextBox CssClass="large-3 medium-3 small-3" ID="CityTB" runat="server" Style="width:300px;"></asp:TextBox>
        <asp:RequiredFieldValidator runat="server" ValidationGroup="register" ControlToValidate="CityTB" ErrorMessage="Stad krävs" ForeColor="Red">*</asp:RequiredFieldValidator>
<%--        <ajaxToolkit:TextBoxWatermarkExtender ID="w6" runat="server" WatermarkText="Stad" TargetControlID="CityTB"></ajaxToolkit:TextBoxWatermarkExtender>--%>
        <asp:Label ID="Label8" runat="server" Text="Land" ForeColor="Navy"></asp:Label>
        <asp:DropDownList CssClass="large-3 medium-3 small-3" runat="server" ID="countryDD"></asp:DropDownList>
        <asp:RequiredFieldValidator runat="server" ValidationGroup="register" ControlToValidate="CountryDD" ErrorMessage="Vänligen välj land" ForeColor="Red">*</asp:RequiredFieldValidator>
